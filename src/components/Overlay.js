...
import { fetchRepos, fetchCommits } from '../store/githubSlice';
import { RepoInfo } from './RepoInfo';
import { LastCommitInfo } from './LastCommitInfo';

const Overlay = () => {
	const dispatch = useDispatch();
	const { reposStatus, repos, commitsStatus, commits } = useSelector((state) => state.github);
	useEffect(() => {
			...
			<div style={{ position: 'absolute', top: 0, left: 0, pointerEvents: 'none', width: '100%', height: '100%' }}>
				<div style={{ position: 'absolute', top: 40, left: 40, fontSize: '13px' }}>
					<a href="https://github.com/hermansochi">
						herman.team dev collective:
					</a>
					<br />
					<a href="https://github.com/hermansochi">hermansochi</a>, 
